...
#import "PMCollectionViewAdPlacerDelegate.h"
...
/**
 * The `PMCollectionViewAdPlacer` class allows you to request native ads from the AdsNative ad server
 ...
 * content cells.
 */
@interface PMCollectionViewAdPlacer : NSObject
 ...
 * `PMServerAdPositions` object as the `positioning` parameter.
 *
 ...
 * implement the `PMAdRendering` protocol and must be a subclass of `UICollectionViewCell`.
 *
 * @return An `PMCollectionViewAdPlacer` object.
 */
...
/**
 * The delegate of an `PMCollectionViewAdPlacer` instance may choose to 
 * implement the `PMCollectionViewAdPlacerDelegate` protocol
 * to get callbacks for impressions and clicks
 */
@property (nonatomic, weak) id<PMCollectionViewAdPlacerDelegate> delegate;
 ...
 * responsibilities related to `PMCollectionViewAdPlacer`. These APIs include methods to help notify
...
@interface UICollectionView (PMCollectionViewAdPlacer)

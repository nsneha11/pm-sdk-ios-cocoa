...
/**
 * The request response delegate of the `PMNativeAd` object. The `PMNativeAdDelegate` protocol has to be implemented
 ...
 * implement the `PMAdRendering` protocol and must be a subclass of `UIView`.
 ...
 * to loads native assets into. The backup rendering class should implement the `PMAdRendering` protocol as well.
 *
 ...
 *
 * The provided view should implement the `PMAdRendering` protocol to correctly display the ad
 * content.
 *

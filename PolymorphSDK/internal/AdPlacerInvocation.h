 ...
 */
@interface AdPlacerInvocation : NSObject
 ...
 * @param streamAdPlacer The StreamAdPlacer backing your UI collection that can translate index paths to their originals.
 *

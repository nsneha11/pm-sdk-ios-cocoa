...
/**
 * The `PMAdRequestTargeting` class is used to attach targeting information to
 * `AdRequest` objects.
 */
@interface PMAdRequestTargeting : NSObject

/** @name Creating a Targeting Object */

/**
 * Creates and returns an empty PMAdRequestTargeting object.
 *
 * @return A newly initialized PMAdRequestTargeting object.
 */
